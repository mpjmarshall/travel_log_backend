...
func (s AdminStore) Overview(ctx context.Context) (admin.Overview, error) {
	...
	if err != nil {
		return admin.Overview{}, fmt.Errorf("postgres: the admin overview: %w", err)
	}
	return o, nil
}
...
func (s AdminStore) Travellers(ctx context.Context, query string, limit, offset int) ([]admin.Traveller, int, error) {
...
func (s AdminStore) Traveller(ctx context.Context, id string) (admin.TravellerDetail, error) {
	var d admin.TravellerDetail
	...
	if err != nil {
		return admin.TravellerDetail{}, fmt.Errorf("postgres: the traveller %s: %w", id, err)
	}
	return d, nil
}
...
func (s AdminStore) Sessions(ctx context.Context, travellerID string) ([]admin.Session, error) {
...
func (s AdminStore) Invites(ctx context.Context) ([]admin.Invite, error) {
